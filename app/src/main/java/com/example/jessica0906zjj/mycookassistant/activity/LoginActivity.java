...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mUsernameLoginBtn = (Button) findViewById(R.id.uesrname_login_in_button);
        mUsernameLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button mUsernameRegisterBtn = (Button) findViewById(R.id.username_register_button);
